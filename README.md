...
```json
{
  ...
  "AI": {
    ...
    "SystemPrompt": "You are a helpful assistant inside a stock trading application. Be concise, accurate, and practical. Do not invent account data, prices, holdings, or actions the user has not provided. If the user asks for financial guidance, clearly avoid pretending to be a licensed financial advisor."
  },
  "Backfill": {
    "BackfillYears": 2,
    "MaxRetries": 3,
